...
export const samples: SamplesContent = {
  ...
  items: [
    {
      id: "demo-audiobook",
      title: "Audiobook Narration Demo",
      audioSrc: "/audio/V03_2-15-Bb.mp3",
      description: "A sample of warm, immersive audiobook narration.",
      category: "audiobook",
    },
    {
      id: "demo-elearning",
      title: "E-Learning Voice Over Sample",
      audioSrc: "/audio/V03_2-15-Bb.mp3",
      description: "A sample of clear, engaging voice over for training and learning content.",
      category: "elearning",
    },
  ],
};
